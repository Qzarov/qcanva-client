...
<style scoped>
.template-page { min-height: 100vh; padding: 20px; background: #0f0f12; color: var(--dark-text-primary, #edf5ef); }.template-header { display:flex; justify-content:space-between; max-width:720px; margin:0 auto 26px; }.template-save-status,.template-kind { color: var(--dark-text-muted, #9aa79e); font-size:13px; }
