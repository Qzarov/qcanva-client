...
<style scoped>
.template-page { min-height: 100vh; padding: 20px; background: #0f0f12; color: var(--dark-text-primary, #edf5ef); }.template-header { display:flex; justify-content:space-between; max-width:720px; margin:0 auto 26px; }.template-header-actions { display:flex; align-items:center; gap:10px; }.template-save-status,.template-kind { color: var(--dark-text-muted, #9aa79e); font-size:13px; }
.template-editor { max-width:720px; margin:auto; }.template-editor-head { display:flex; justify-content:space-between; gap:16px; align-items:end; margin-bottom:20px; }.template-editor-head label { display:grid; gap:6px; color:#aab7ae; font-size:13px; }.template-editor-head input { width:min(360px,75vw); padding:9px; border-radius:6px; border:1px solid #3b4940; background:#1b211e; color:#edf5ef; }
.character-sheet { max-width:560px; padding:20px; background:#171a19; border:1px solid #3b4940; border-radius:12px; }.character-sheet-head { display:flex; align-items:center; gap:12px; border-bottom:1px solid #354039; padding-bottom:12px; }.character-sheet-head>input { flex:1; min-width:0; font-size:20px; font-weight:700; }.character-sheet input { color:#edf5ef; background:#222825; border:1px solid #3b4940; border-radius:5px; padding:5px; }.character-sheet-head>input { background:transparent; border:0; }.character-sheet-head span input { width:42px; }.character-sheet-stats { display:flex; gap:16px; margin:14px 0; }.character-sheet-stats label,.character-sheet-abilities label { display:grid; gap:4px; color:#aab7ae; font-size:12px; }.character-sheet-stats input { width:54px; }.character-sheet-abilities { display:grid; grid-template-columns:repeat(3,1fr); gap:8px; }.character-sheet-abilities input { width:100%; box-sizing:border-box; font-weight:700; }.template-portrait { position:relative; display:grid; flex:0 0 62px; place-items:center; width:62px; height:62px; overflow:visible; border:1px solid #435248; border-radius:50%; background:#263329; color:#77ee9a; font-size:23px; font-weight:700; }.template-portrait img { width:100%; height:100%; border-radius:50%; object-fit:cover; }.template-portrait button { position:absolute; right:-5px; bottom:-4px; width:20px; height:20px; padding:0; border:1px solid #5c7665; border-radius:50%; color:#d8f9df; background:#1d3924; cursor:pointer; }.template-portrait button + button { right:-25px; }.template-error { text-align:center; color:#ff9898; }
</style>
