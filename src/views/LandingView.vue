...
.hero-copy h1 em { color:var(--ui-brand); font-family:inherit; font-style:normal; }
...
.hero-primary:hover, .landing-register:hover { background:var(--ui-focus); }
.hero-secondary { color:var(--ui-text); }
.hero-note { color:var(--ui-text-muted); }
...
.landing-features article { padding:20px; border:1px solid var(--ui-border); border-radius:var(--radius-md); background:var(--ui-surface); }.section-intro { padding:20px 0; }.feature-icon { color:var(--ui-brand-on); background:var(--ui-brand); }.coral { background:var(--accent-yellow); }.mint { background:var(--accent-green); }.landing-features h3 { color:var(--ui-text); }.landing-features p { color:var(--ui-text-muted); }
...
.landing-workflow { background:var(--ui-surface); border-color:var(--ui-border); border-radius:var(--radius-lg); }.landing-workflow>div p, .landing-workflow li p { color:var(--ui-text-muted); }.landing-workflow li { border-bottom-color:var(--ui-border); }.landing-workflow li>b { color:var(--ui-brand); }.landing-workflow strong { color:var(--ui-text); }.text-cta { color:var(--ui-brand); }
.landing-final { background:linear-gradient(135deg, var(--ui-brand-soft), var(--ui-surface)); border:1px solid var(--ui-border); border-radius:var(--radius-xl); color:var(--ui-text); }.landing-final h2,.landing-final p,.landing-final a:not(.hero-primary) { color:var(--ui-text); }.landing-final .hero-primary,.landing-final .hero-primary span { background:var(--ui-brand); color:var(--ui-brand-on); }.landing-footer { color:var(--ui-text-muted); }
...
.agents-copy > span { color:var(--ui-focus); font-size:10px; font-weight:800; letter-spacing:.12em; }.agents-copy h2 { margin:14px 0; font-size:33px; letter-spacing:-.05em; line-height:1.12; }.agents-copy > p { max-width:470px; margin:0; color:var(--ui-text-muted); font-size:13px; line-height:1.65; }
...
.landing-formula { max-width:1444px; min-height:116px; margin:-45px auto 70px; padding:0 28px; display:flex; align-items:center; justify-content:center; gap:26px; border-top:1px solid var(--ui-border); border-bottom:1px solid var(--ui-border); color:var(--ui-text); font-size:clamp(18px,2vw,28px); font-weight:850; }.landing-formula b { color:var(--ui-text-muted); font-weight:400; }.landing-formula em { color:var(--ui-brand); font-style:normal; }
