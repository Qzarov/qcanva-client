...
.landing-header { border-bottom:1px solid var(--ui-border); }
.landing-brand { color:var(--ui-text); }
.brand-logo { width: 30px; height: 30px; border-radius: 9px; object-fit: cover; }
.landing-nav a, .landing-login, .landing-footer a { color:var(--ui-text-secondary); }
.landing-register { color:var(--ui-brand-on); background:var(--ui-brand); border-radius:var(--radius-sm); }
.landing-hero { background:linear-gradient(135deg, var(--ui-brand-soft), var(--ui-surface)); border:1px solid var(--ui-border); border-radius:var(--radius-xl); }
.hero-kicker, .section-intro>span, .landing-workflow>div>span, .landing-final>span { color:var(--ui-focus); font-family:inherit; font-weight:700; }
.hero-kicker span { background:var(--ui-brand); }
.hero-copy h1 { color:var(--ui-text); letter-spacing:-.045em; }
.hero-copy h1 em { color:var(--ui-accent-strong); font-family:inherit; font-style:normal; }
.hero-copy p { color:var(--ui-text-secondary); }
.hero-primary { color:var(--ui-brand-on); background:var(--ui-brand); border-radius:var(--radius-sm); }
.hero-primary:hover, .landing-register:hover { color:var(--ui-focus-on); background:var(--ui-focus); }
.hero-secondary { color:var(--ui-text); }
.hero-note { color:var(--ui-text-secondary); }
.avatars i { border-color:var(--ui-surface); color:var(--ui-brand-on); background:var(--ui-brand); }
.avatars i:nth-child(2) { background:var(--accent-green); }.avatars i:last-child { color:var(--ui-text); background:var(--ui-surface); }
.hero-visual { border:1px solid var(--ui-border); border-radius:var(--radius-lg); background:var(--ui-canvas); box-shadow:var(--ui-shadow); transform:rotate(0); }
...
.card-plan { color:var(--content-preview-text); background:rgba(0,42,0,.95); border:1px solid #22502a; }.card-plan i { background:var(--color-brands); }
.card-note { color:#102515; background:var(--accent-green); }.card-doc { color:var(--content-preview-text); background:#292d37; border:1px solid #444958; }.canvas-card p { color:var(--content-preview-muted); }.canvas-lines { stroke:var(--color-brands); opacity:.75; }
.landing-features article { padding:20px; border:1px solid var(--ui-border); border-radius:var(--radius-md); background:var(--ui-surface); }.section-intro { padding:20px 0; }.feature-icon { color:var(--ui-brand-on); background:var(--ui-brand); }.coral { background:var(--accent-yellow); }.mint { background:var(--accent-green); }.landing-features h3 { color:var(--ui-text); }.landing-features p { color:var(--ui-text-secondary); }
...
.landing-workflow { background:var(--ui-surface); border-color:var(--ui-border); border-radius:var(--radius-lg); }.landing-workflow>div p, .landing-workflow li p { color:var(--ui-text-secondary); }.landing-workflow li { border-bottom-color:var(--ui-border); }.landing-workflow li>b { color:var(--ui-accent-strong); }.landing-workflow strong { color:var(--ui-text); }.text-cta { color:var(--ui-accent-strong); }
.landing-final { background:linear-gradient(135deg, var(--ui-brand-soft), var(--ui-surface)); border:1px solid var(--ui-border); border-radius:var(--radius-xl); color:var(--ui-text); }.landing-final h2,.landing-final p,.landing-final a:not(.hero-primary) { color:var(--ui-text); }.landing-final .hero-primary,.landing-final .hero-primary span { background:var(--ui-brand); color:var(--ui-brand-on); }.landing-footer { color:var(--ui-text-secondary); }
.landing-agents { max-width:1120px; margin:0 auto 105px; padding:56px 62px; display:grid; grid-template-columns:1fr 1fr; gap:74px; align-items:center; box-sizing:border-box; border-radius:var(--radius-lg); background:var(--ui-surface); border:1px solid var(--ui-border); }
.agents-copy > span { color:var(--ui-focus); font-size:10px; font-weight:800; letter-spacing:.12em; }.agents-copy h2 { margin:14px 0; font-size:33px; letter-spacing:-.05em; line-height:1.12; }.agents-copy > p { max-width:470px; margin:0; color:var(--ui-text-secondary); font-size:13px; line-height:1.65; }
.agents-points { display:grid; gap:11px; margin-top:24px; }.agents-points div { display:flex; gap:10px; align-items:center; color:var(--ui-text-secondary); font-size:12px; }.agents-points b { display:grid; place-items:center; width:20px; height:20px; border-radius:6px; color:var(--ui-brand-on); background:var(--accent-green); font-size:12px; }
...
.landing-formula { max-width:1444px; min-height:116px; margin:-45px auto 70px; padding:0 28px; display:flex; align-items:center; justify-content:center; gap:26px; border-top:1px solid var(--ui-border); border-bottom:1px solid var(--ui-border); color:var(--ui-text); font-size:clamp(18px,2vw,28px); font-weight:850; }.landing-formula b { color:var(--ui-text-secondary); font-weight:400; }.landing-formula em { color:var(--ui-accent-strong); font-style:normal; }
...
.landing-use-cases,.landing-context,.landing-templates { max-width:1120px; margin:0 auto 105px; padding:0 26px; box-sizing:border-box; }.landing-use-cases>.section-intro,.landing-templates>.section-intro { display:grid; grid-template-columns:1fr 1fr; gap:26px; align-items:end; margin-bottom:34px; }.landing-use-cases>.section-intro span,.landing-templates>.section-intro span,.context-copy>span { color:var(--ui-focus); font-size:10px; font-weight:800; letter-spacing:.13em; }.landing-use-cases>.section-intro h2,.landing-templates>.section-intro h2,.context-copy h2 { margin:8px 0 0; font-size:38px; letter-spacing:-.05em; line-height:1.05; }.landing-use-cases>.section-intro p,.landing-templates>.section-intro p,.context-copy p { margin:0; color:var(--ui-text-secondary); font-size:13px; line-height:1.65; }
.use-layout { display:grid; grid-template-columns:.72fr 1.28fr; gap:18px; }.case-menu,.case-stage { border:1px solid var(--ui-border); border-radius:18px; background:var(--ui-surface); }.case-menu { padding:14px; }.case-btn { width:100%; padding:16px 15px; display:flex; justify-content:space-between; border:0; border-bottom:1px solid var(--ui-border); color:var(--ui-text-secondary); background:transparent; cursor:pointer; text-align:left; }.case-btn:last-of-type { border-bottom:0; }.case-btn.active { border-radius:10px; color:var(--ui-brand-on); background:var(--ui-brand); }.case-copy { margin:18px 8px 4px; min-height:66px; color:var(--ui-text-secondary); font-size:12px; line-height:1.55; }.case-stage { padding:18px; overflow:hidden; }.stage-label { display:flex; align-items:center; gap:8px; color:var(--ui-text-secondary); font-size:11px; }.stage-label i { width:7px; height:7px; border-radius:50%; background:var(--ui-brand); }
.stage-canvas { position:relative; min-height:390px; margin-top:15px; border-radius:14px; background-color:#1a1e22; background-image:linear-gradient(#ffffff0b 1px,transparent 1px),linear-gradient(90deg,#ffffff0b 1px,transparent 1px); background-size:28px 28px; }.case-tile { position:absolute; z-index:2; width:160px; padding:15px; border:1px solid #445049; border-radius:11px; background:#072810; color:var(--content-preview-text); box-shadow:0 8px 20px #0003; }.case-tile small { color:var(--content-preview-muted); font-size:8px; letter-spacing:.11em; text-transform:uppercase; }.case-tile h3 { margin:9px 0 5px; color:inherit; font-size:14px; }.case-tile p { margin:0; color:var(--content-preview-muted); font-size:9px; }.case-tile-1 { left:6%; top:9%; }.case-tile-2 { right:7%; top:15%; background:#2b3038; }.case-tile-3 { left:35%; top:40%; background:#043c0c; }.case-tile-4 { right:10%; bottom:8%; }.case-tile-5 { left:8%; bottom:10%; background:#234636; }.stage-line { position:absolute; z-index:1; height:2px; background:#00ff00; opacity:.5; transform-origin:left; }.stage-line-one { width:190px; left:22%; top:28%; transform:rotate(22deg); }.stage-line-two { width:230px; left:25%; bottom:26%; transform:rotate(-13deg); }
.landing-context { padding:48px; display:grid; grid-template-columns:.85fr 1.15fr; gap:55px; align-items:center; border:1px solid var(--ui-border); border-radius:18px; background:var(--ui-surface); }.context-map { position:relative; min-height:340px; }
.context-node { position:absolute; z-index:2; min-width:145px; padding:14px; display:grid; gap:5px; border:1px solid #405047; border-radius:11px; background:#202622; color:var(--content-preview-text); font-size:12px; }.context-node small { color:var(--content-preview-muted); font-size:9px; }.context-node.primary { left:36%; top:39%; color:#002400; background:#00ff00; }.context-node.primary small { color:#075c07; }.mint-node { left:4%; top:7%; background:#59d7bf; color:#073b31; }.decision-node { right:0; top:8%; }.yellow-node { left:5%; bottom:4%; background:#f4e65a; color:#3c3500; }.ai-node { right:1%; bottom:5%; }.map-line { position:absolute; z-index:1; left:24%; top:31%; width:270px; height:2px; background:rgba(0,255,0,.45); transform:rotate(14deg); }.ml-two { top:67%; transform:rotate(-14deg); }
.templates-grid { grid-column:1/-1; display:grid; grid-template-columns:repeat(3,1fr); gap:18px; }.template-preview-card { overflow:hidden; border:1px solid var(--ui-border); border-radius:16px; color:var(--ui-text); background:var(--ui-surface); text-decoration:none; transition:transform .2s ease,border-color .2s ease; }.template-preview-card:hover { transform:translateY(-4px); border-color:var(--ui-focus); }.template-preview-card>div:last-child { position:relative; padding:18px; }.template-preview-card h3 { margin:0 0 7px; font-size:15px; }.template-preview-card p { margin:0; color:var(--ui-text-secondary); font-size:11px; }.template-preview-card b { position:absolute; right:18px; top:18px; color:var(--ui-accent-strong); }
.template-mini { position:relative; min-height:180px; background-color:#1a1e22; background-image:linear-gradient(#ffffff0a 1px,transparent 1px),linear-gradient(90deg,#ffffff0a 1px,transparent 1px); background-size:24px 24px; }.template-mini i { position:absolute; width:75px; height:46px; border-radius:8px; background:#043c0c; }.template-mini i:first-child { left:12%; top:20%; }.template-mini i:nth-child(2) { right:12%; top:36%; background:#59d7bf; }.template-mini i:last-child { left:34%; bottom:12%; background:#2b3038; }
