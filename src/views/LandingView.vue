...
.landing-final { background:linear-gradient(135deg, var(--ui-brand-soft), var(--ui-surface)); border:1px solid var(--ui-border); border-radius:var(--radius-xl); }.landing-final .hero-primary { background:var(--ui-brand); color:var(--ui-brand-on); }.landing-footer { color:var(--ui-text-muted); }
